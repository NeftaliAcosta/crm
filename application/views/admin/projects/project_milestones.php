...
<div class="tasks-phases">
    ...
    <div class="row">
        ...
        foreach($milestones as $milestone){
            ...
            ?>
        <div class="col-md-3 mtop25 milestone-column" data-milestone-id="<?php echo $milestone['id']; ?>">
            ...
            <div class="panel-body">
                ...
                <li data-task-id="<?php echo $task['id']; ?>" class="task<?php if(has_permission('tasks','','create') || has_permission('tasks','','edit')){echo ' sortable';} ?>">
                <div class="media">
                    ...
                    <div class="media-body">
                        <a href="#" class="task_milestone pull-left mtop5<?php if($task['finished'] == 1){echo ' text-muted';} ?>" onclick="init_task_modal(<?php echo $task['id']; ?>); return false;"><?php echo $task['name']; ?></a>
                        <?php if(has_permission('tasks','','create')){ ?>
