         ...
         <div class="col-md-12">
            ...
            <div class="panel_s">
               <div class="panel-body _buttons">
                  <a href="#" onclick="init_lead(); return false;" class="btn new-lead mright5 btn-info pull-left display-block">
                  ...
                  <div class="row">
                     <div class="col-md-5">
                        ...
                        <a href="<?php echo admin_url('leads/switch_list/'.$switch_list); ?>" class="btn btn-default mleft10">
                        <?php if($switch_list == 1){ echo _l('switch_to_list_view');}else{echo _l('leads_switch_to_kanban');}; ?>
                        </a>
                     </div>
                     <div class="col-md-4 col-xs-12 pull-right leads-search">
                        <?php if($this->session->userdata('leads_list_view') != 'true') { ?>
                        <?php echo render_input('search','','','search',array('data-name'=>'search','onkeyup'=>'leads_kanban(this.value);','placeholder'=>_l('leads_search')),array(),'no-margin') ?>
                        <?php } ?>
               ...
               <div class="panel-body">
                  <div class="tab-content">
                     ...
                     <div class="row" id="leads-table">
                        <div class="col-md-12">
                        <div class="_buttons">
                           <div class="btn-group pull-left" data-toggle="tooltip" title="<?php echo _l('filter_by'); ?>">
                        ...
                        <div class="col-md-12">
                           <?php
                              ...
                              $_op = _l('options');
                              if(is_admin()){
                                 $_op .= '<div class="checkbox hide mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="leads"><label></label></div>';
                              }
