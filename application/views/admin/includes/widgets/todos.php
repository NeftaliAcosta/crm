 <div class="panel_s todo-panel">
   <div class="panel-body padding-10">
      ...
      <a href="#__todo" data-toggle="modal" class="pull-right mbot20">
      ...
      <ul class="list-unstyled todo unfinished-todos todos-sortable sortable">
         <?php foreach($todos as $todo) { ?>
            <li>
               ...
               <span class="todo-description" data-todo-description="<?php echo $todo['todoid']; ?>"><?php echo $todo['description']; ?><a href="#" onclick="delete_todo_item(this,<?php echo $todo['todoid']; ?>)" class="pull-right text-muted"><i class="fa fa-remove"></i></a><a href="#" onclick="edit_todo_item(<?php echo $todo['todoid']; ?>); return false;" class="pull-right text-muted mright5"><i class="fa fa-pencil-square-o"></i></a></span>
