                                ...
                                <select class="selectpicker" name="expense_year" onchange="filter_expenses();" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                    ...
                                    <div class="panel_s">
                                        <div class="panel-body">
                                            ...
                                            // Ge the expenses
                                                                    $this->db->select('amount,taxrate,tblexpenses.tax')->from('tblexpenses')->join('tbltaxes','tbltaxes.id = tblexpenses.tax','left')->where('MONTH(date)',$m)->where('YEAR(date)',$current_year)->where('category',$category['id'])->where('currency',$_currency->id);
                                        ...
                                        // Sum and add the total for current category for all months
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <canvas class="chart" id="expenses_chart_not_billable" height="150"></canvas>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <canvas class="chart" id="expenses_chart_billable" height="150"></canvas>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php init_tail(); ?>
                                    <script src="<?php echo site_url('assets/plugins/excellentexport/excellentexport.min.js'); ?>"></script>
                                    <script>
