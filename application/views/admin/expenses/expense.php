...
<div id="wrapper">
   <div class="content">
      <div class="row">
         ...
         <div class="col-md-6">
            <div class="panel_s">
               <div class="panel-heading"><?php echo _l('advanced_options'); ?></div>
               <div class="panel-body">
               <?php
                  ...
                  <div id="expense_currency">
                    <?php echo render_select('currency',$currencies,array('id','symbol','name'),'expense_currency',$selected,$s_attrs); ?>
                  </div>
