    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-6 border-right">
                ...
                <div class="form-group projects-wrapper<?php if(!isset($estimate) && !isset($customer_id)){ echo ' hide';} ?>">
                    ...
                    <select name="project_id" class="selectpicker projects" data-live-search="true" data-width="100%" data-non-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                        ...
                        <?php
                        $where = array();
                        if(isset($estimate) || isset($customer_id)){
                        ...
                        foreach($projects as $project){
                            $selected = '';
                            if(isset($estimate)){
                              if($project['id'] == $estimate->project_id){
                                $selected = 'selected';
                            }
                        }
