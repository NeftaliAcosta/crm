                        ...
                        <div class="display-block text-right">
                            <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
                                ...
                                <ul class="dropdown-menu width300">
                                    ...
                                    <li class="<?php if($chosen_status == strval ($status)){echo 'active';} ?>">
...
<script>
    ...
    $(document).ready(function(){
        ...
        initDataTable('.table-proposals', window.location.href, ['undefined'], ['undefined'], Proposals_ServerParams, [6, 'DESC']).column(0).visible(false, false).columns.adjust().draw(false);
        init_proposal();
    });
</script>
