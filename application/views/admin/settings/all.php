            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <?php if(is_admin()){ ?>
                        V<?php echo wordwrap($current_version,1,'.',true); ?> - <a href="#" class="mbot15 inline-block new-version-check" data-toggle="tooltip" data-title="<?php echo _l('current_version',wordwrap($current_version,1,'.',true)); ?>"><?php echo _l('check_for_new_version'); ?></a>
                        <?php } ?>
