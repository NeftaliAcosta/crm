<ul class="nav nav-tabs" role="tablist">
 <li role="presentation" class="active">
  ...
  <li role="presentation">
    <a href="#online_payments_2checkout_tab" aria-controls="online_payments_2checkout_tab" role="tab" data-toggle="tab">2Checkout</a>
  </li>
</ul>
<div class="tab-content mtop30">
 ...
 <!-- Stripe -->
 <div role="tabpanel" class="tab-pane" id="online_payments_2checkout_tab">
  <div class="row">
    <div class="col-md-6">
     <h4>2Checkout</h4>
     <p class="text-warning"><?php echo _l('2checkout_usage_notice'); ?></p>
     <hr />
     <?php render_yes_no_option('paymentmethod_two_checkout_active','settings_paymentmethod_active'); ?>

     <?php echo render_input('settings[paymentmethod_two_checkout_label]','settings_paymentmethod_mode_label',get_option('paymentmethod_two_checkout_label')); ?>

     <?php echo render_input('settings[paymentmethod_two_checkout_account_number]','paymentmethod_two_checkout_account_number',get_option('paymentmethod_two_checkout_account_number')); ?>

     <?php echo render_input('settings[paymentmethod_two_checkout_private_key]','paymentmethod_two_checkout_private_key',$this->encryption->decrypt(get_option('paymentmethod_two_checkout_private_key'))); ?>

     <?php echo render_input('settings[paymentmethod_two_checkout_publishable_key]','paymentmethod_two_checkout_publishable_key',get_option('paymentmethod_two_checkout_publishable_key')); ?>

     <?php echo render_input('settings[paymentmethod_two_checkout_currencies]','settings_paymentmethod_currencies',get_option('paymentmethod_two_checkout_currencies')); ?>

     <?php render_yes_no_option('paymentmethod_two_checkout_test_mode_enabled','settings_paymentmethod_testing_mode'); ?>
   </div>
 </div>
</div>
</div>
