    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane ptop10" id="contacts">
                ...
                <a href="#" onclick="contact(<?php echo $client->userid; ?>); return false;" class="btn btn-info mbot25"><?php echo _l('new_contact'); ?></a>
                <?php } ?>
                <?php
                    $table_data = array(_l('client_firstname'),_l('client_lastname'),_l('client_email'),_l('client_phonenumber'),_l('contact_active'),_l('clients_list_last_login'));
            ...
            <div role="tabpanel" class="tab-pane ptop10" id="customer_admins">
                ...
                <a href="#" data-toggle="modal" data-target="#customer_admins_assign" class="btn btn-info mbot15"><?php echo _l('assign_admin'); ?></a>
                <?php } ?>
            ...
            <div role="tabpanel" class="tab-pane ptop10" id="billing_and_shipping">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <h4><?php echo _l('billing_address'); ?> <a href="#" class="pull-right text-uppercase billing-same-as-customer"><small class="label label-primary"><?php echo _l('customer_billing_same_as_profile'); ?></small></a></h4>
                            ...
                            <div class="col-md-6">
                                <h4><?php echo _l('shipping_address'); ?> <a href="#" class="pull-right text-uppercase customer-copy-billing-address"><small class="label label-primary"><?php echo _l('customer_billing_copy'); ?></small></a></h4>
